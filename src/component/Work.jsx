  ...
  return (
    <div className='work py-3 container-fluid'>
      ...
      <div className='row gap-3 m-auto justify-content-center border'>
        <div className="parent-project col-3 border bg-white  rounded" style={{width:'250px',height:'220px',overflow:'hidden'}}>
          <div className='project '>
            ...
            <h4 className='abril-fatface-regular' style={{color:'#f7ad23'}}>e-commerce</h4>
            <p className='text-muted afacad-flux'>yegzf zeufef zekfef zeyfef efjfhefefhezf zefhezfzefghzerogzr egfz</p>
            <p className='fw-bold' style={{color:"#294129"}}>HTML cSS JS TAILWIND REACT BOOTSTRA</p>
          </div>
        </div>
        <div className="col-3 bg-dark" style={{width:'250px',height:'220px'}}></div>
